package dk.jarry.aws.alb.control;
...
public class Alb extends Construct {
	...
	public Alb(Construct scope, Vpc vpc, String loadBalancerName) {
		...
		this.applicationLoadBalancer = ApplicationLoadBalancer.Builder.create(this, "ELB").internetFacing(true)
				.loadBalancerName(loadBalancerName).vpc(vpc).build();
	}
